...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/dataList.js":[function(require,module,exports) {
...
function start(bank) {
  var payoutLi = document.querySelectorAll('.payout__list');
  var num = 5; // payoutLi[2].appendChild(ulElem)

  var bankData = bank.bankList;
  payoutLi.forEach(function (e, i) {
    // payoutLi[i].appendChild(ulElem)
    var ulElem = document.createElement('ul');
    payoutLi[i].appendChild(ulElem).classList.add('payout__list__contents'); //반복문

    for (var _i = 0; _i < 5; _i++) {
      var liElem = document.createElement('li');
      var spanElem = document.createElement('span');
      var pElem = document.createElement('p');
      spanElem.textContent = bank.bankList[_i].history;
      pElem.textContent = bank.bankList[_i].price;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/dataList.js"], null)
//# sourceMappingURL=/dataList.98184219.js.map